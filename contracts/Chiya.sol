...
contract Chiya is Context, IERC20, Ownable {
    ...
    address payable public treasuryWalletAddress = payable(0xc713a94F3eA0127F581f8c51BA759b612068282d); // Treasury Address
    ...
    uint256 public _numTokensSellToAddToLiquidity = 10**10 * 10**9;
    ...
    function setTaxes(uint256 newRewardFee, uint256 newLiquidityFee, uint256 newMarketingfee, uint256 newTreasuryFee) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(forWallets > 0 && _marketingFee.add(_treasuryFee) > 0)
        {
            ...
            uint256 treasuryShare = newBalance.sub(marketingShare);
            
            if(marketingShare > 0)
                transferToAddressETH(marketingWalletAddress, marketingShare);
            
            if(treasuryShare > 0)
                transferToAddressETH(treasuryWalletAddress, treasuryShare);
        }
    }
